...
var _SessionTokenContext = _interopRequireDefault(
  require("../contexts/SessionTokenContext")
)
...
function SessionProvider(props) {
  ...
  ;(0, _react.useEffect)(
    function () {
      if (app) {
        ;(0, _appBridgeUtils.getSessionToken)(app)
  ...
  var loadingMarkup = props.renderLoading
    ? props.renderLoading
  ...
  return /*#__PURE__*/ _react["default"].createElement(
    _SessionTokenContext["default"].Provider,
    {
      value: sessionToken,
    },
